...
@Getter
public class V1PromotedNewFamilyListItem {
    ...
    public V1PromotedNewFamilyListItem(Long newFamilyId, String name, Sex sex, String phoneNumber, Integer grade, String newFamilyGroupLeaderName, String smallGroupLeaderName, LocalDate promoteDate) {
